...
export default function App() {
  ...
  useEffect(() => {
    ...
    const serverUrl = import.meta.env.VITE_SERVER_URL || import.meta.env.VITE_API_URL || window.location.origin;
    socket = io(serverUrl, {
      reconnection: true,
                        ...
                        >
                          <div className="flex items-center gap-3 min-w-0">
                            ...
                            <div className="truncate">
                              <p className="text-sm font-semibold truncate flex items-center gap-1.5 text-neutral-200">
                                {p.name}
                                {isMe && <span className="text-[9px] text-blue-400 font-bold bg-blue-500/10 px-1 py-0.5 rounded uppercase">YOU</span>}
